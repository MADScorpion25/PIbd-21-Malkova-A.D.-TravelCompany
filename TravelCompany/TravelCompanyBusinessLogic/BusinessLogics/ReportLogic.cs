...
namespace TravelCompanyBusinessLogic.BusinessLogics
{
    public class ReportLogic : IReportLogic
    {
        ...
        private readonly IWarehouseLogic _warehouseStorage;
        private readonly AbstractSaveToExcel _saveToExcel;
        private readonly AbstractSaveToWord _saveToWord;
        private readonly AbstractSaveToPdf _saveToPdf;
        public ReportLogic(ITravelStorage travelStorage, IConditionStorage
       conditionStorage, IOrderStorage orderStorage, IWarehouseLogic warehouseStorage,
       ...
       AbstractSaveToPdf saveToPdf)
        ...
        public List<ReportWarehouseConditionViewModel> GetWarehouseCondition()
        {
        ...
        {
            _saveToExcel.CreateReportWarehouseCondition(new ExcelInfoWarehouses
            {
                FileName = model.FileName,
                Title = "Список условий складов",
                WarehouseConditions = GetWarehouseCondition()
            });
        }
    }
}
