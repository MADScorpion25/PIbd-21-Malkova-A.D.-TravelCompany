...
namespace TravelCompanyDatabaseImplement.Migrations
{
    ...
    [Migration("20220310132201_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCompanyDatabaseImplement.Models.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelCompanyDatabaseImplement.Models.WarehouseCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelCompanyDatabaseImplement.Models.WarehouseCondition", b =>
                {
                    b.HasOne("TravelCompanyDatabaseImplement.Models.Condition", "Condition")
                        .WithMany("WarehouseConditions")
                        .HasForeignKey("ConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelCompanyDatabaseImplement.Models.Warehouse", "Warehouse")
                        .WithMany("WarehouseConditions")
            ...
            modelBuilder.Entity("TravelCompanyDatabaseImplement.Models.Condition", b =>
                {
                    ...
                    b.Navigation("WarehouseConditions");
                });
