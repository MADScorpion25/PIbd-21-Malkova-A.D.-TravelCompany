...
{
    public partial class FormReportWarehouseConditions : Form
    {
        private readonly IReportLogic _logic;
        public FormReportWarehouseConditions(IReportLogic logic)
        {
            InitializeComponent();
            _logic = logic;
        }
        ...
        private void FormReportWarehouseConditions_Load(object sender, EventArgs e)
        {
            try
            {
