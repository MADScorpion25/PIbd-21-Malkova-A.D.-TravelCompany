...
namespace TravelCompanyRestApi.Controllers
{
    ...
    public class WarehouseController : Controller
    {
        ...
        private readonly IConditionLogic componentLogic;
        public WarehouseController(IWarehouseLogic warehouseLogic, IConditionLogic componentLogic)
        {
        ...
        [HttpGet]
        public List<ConditionViewModel> GetConditionsList() => componentLogic.Read(null)?.ToList();
        [HttpPost]
        ...
        [HttpPost]
        public void AddConditionWarehouse(WarehouseConditionsBindingModel model) =>
            warehouseLogic.AddCondition(new WarehouseBindingModel { Id = model.WarehouseId }, model.ConditionId, model.Count);
    }
}
